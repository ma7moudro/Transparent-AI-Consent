...
* **Database & ORM:** Prisma **v5.14.0** (Explicitly locked to this stable version to ensure flawless schema generation and avoid recent v7.x build conflicts during deployment).
